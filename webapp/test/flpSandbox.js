		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product2",
									"targetURL": "#sapcomproduct2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomproduct2-display": {
								"semanticObject": "sapcomproduct2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.product2",
									"url": sap.ui.require.toUrl("sap/com/product2")
								}
							}
						}
					}
